// qaabka 1aad Samaynta Tuple ka kooban: [string, number, number]
let location: [string, number, number];

// --- Tijaabinta  Saxda ah Correct Order -
// --
location = ["Mogadishu", 2.0371, 45.3438];
// Waa sax!

// --- (Incorrect Orders) ---

// Tarinta  qaldan 1: Latitude-ka oo la hor mariyay
location = [2.0371, "Mogadishu", 45.3438];
// Error: Type 'number' is not assignable to type 'string'.

// Tarrinta qaldan 2: Qodobo ka yar ama ka badan intii loo baahnaa
